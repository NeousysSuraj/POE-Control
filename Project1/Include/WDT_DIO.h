...
// LED, mode
//
#define LED_DISABLE         (0x00)  // disable output
#define LED_MODE_CC         (0x01)  // constant current
#define LED_MODE_CV         (0x02)  // constant voltage
#define LED_MODE_CD         (0x03)  // constant current with duty cycle
...
typedef struct IGN_SETTING_T
{
    ...
    DWORD   onDelay;            // [out] turn on delay time, in seconds
    DWORD   offDelay;           // [out] turn off delay time, in seconds
    DWORD   hardOffTimeout;     // [out] hard off timeout, in seconds
...
typedef struct DT2_SETUP_T
{
    ...
    DWORD   trigData;       // [in ] trigger data, ex: qei position ...
    ...
    DWORD   pulseData1;     // [in ] output pulse data 1, reserved
    DWORD   pulseData2;     // [in ] output pulse data 2, reserved
}
...
#define DT2_TRIG_EIDD       (0x04)  // external input (default deactivated)
#define DT2_TRIG_EIDA       (0x08)  // external input (default activated)
...
#define DT2_TRIG_RISING     (0x01)
#define DT2_TRIG_FALLING    (0x02)
#define DT2_TRIG_LEVEL      (0x03)
#define DT2_TRIG_ALWAYS     (0x04)
#define DT2_TRIG_ABOVE      (0x01)
#define DT2_TRIG_BELOW      (0x02)

// DT2_SETUP.trigSrc
//
#define DT2_SRC_DI_00       (0x00010001)
#define DT2_SRC_DI_01       (0x00010002)
#define DT2_SRC_DI_02       (0x00010004)
#define DT2_SRC_DI_03       (0x00010008)
#define DT2_SRC_DI_04       (0x00010010)
#define DT2_SRC_DI_05       (0x00010020)
#define DT2_SRC_DI_06       (0x00010040)
#define DT2_SRC_DI_07       (0x00010080)
//
#define DT2_SRC_DO_00       (0x00020001)
#define DT2_SRC_DO_01       (0x00020002)
#define DT2_SRC_DO_02       (0x00020004)
#define DT2_SRC_DO_03       (0x00020008)
#define DT2_SRC_DO_04       (0x00020010)
#define DT2_SRC_DO_05       (0x00020020)
#define DT2_SRC_DO_06       (0x00020040)
#define DT2_SRC_DO_07       (0x00020080)
#define DT2_SRC_DO_08       (0x00020100)
#define DT2_SRC_DO_09       (0x00020200)
#define DT2_SRC_DO_10       (0x00020400)
#define DT2_SRC_DO_11       (0x00020800)
//
#define DT2_SRC_SI_00       (0x40000001)
#define DT2_SRC_SI_01       (0x40000002)
#define DT2_SRC_SI_02       (0x40000004)  // reserved
#define DT2_SRC_SI_03       (0x40000008)  // reserved
#define DT2_SRC_SI_04       (0x40000010)  // reserved
#define DT2_SRC_SI_05       (0x40000020)  // reserved
#define DT2_SRC_SI_06       (0x40000040)  // reserved
#define DT2_SRC_SI_07       (0x40000080)  // reserved
//
#define DT2_SRC_SO_00       (0x80000001)
#define DT2_SRC_SO_01       (0x80000002)
#define DT2_SRC_SO_02       (0x80000004)  // reserved
#define DT2_SRC_SO_03       (0x80000008)  // reserved
#define DT2_SRC_SO_04       (0x80000010)  // reserved
#define DT2_SRC_SO_05       (0x80000020)  // reserved
#define DT2_SRC_SO_06       (0x80000040)  // reserved
#define DT2_SRC_SO_07       (0x80000080)  // reserved
//
...
//
#define DT2_SRC_LED_0       (0x00200001)
#define DT2_SRC_LED_1       (0x00200002)
#define DT2_SRC_LED_2       (0x00200004)
#define DT2_SRC_LED_3       (0x00200008)

// DT2_SETUP.trigTgt
//
#define DT2_TGT_DO_00       (0x00020001)
#define DT2_TGT_DO_01       (0x00020002)
#define DT2_TGT_DO_02       (0x00020004)
#define DT2_TGT_DO_03       (0x00020008)
#define DT2_TGT_DO_04       (0x00020010)
#define DT2_TGT_DO_05       (0x00020020)
#define DT2_TGT_DO_06       (0x00020040)
#define DT2_TGT_DO_07       (0x00020080)
#define DT2_TGT_DO_08       (0x00020100)
#define DT2_TGT_DO_09       (0x00020200)
#define DT2_TGT_DO_10       (0x00020400)
#define DT2_TGT_DO_11       (0x00020800)
#define DT2_TGT_DO_12       (0x00021000)
#define DT2_TGT_DO_13       (0x00022000)
#define DT2_TGT_DO_14       (0x00024000)
#define DT2_TGT_DO_15       (0x00028000)
//
#define DT2_TGT_SO_00       (0x80000001)
#define DT2_TGT_SO_01       (0x80000002)
#define DT2_TGT_SO_02       (0x80000004)  // reserved
#define DT2_TGT_SO_03       (0x80000008)  // reserved
#define DT2_TGT_SO_04       (0x80000010)  // reserved
#define DT2_TGT_SO_05       (0x80000020)  // reserved
#define DT2_TGT_SO_06       (0x80000040)  // reserved
#define DT2_TGT_SO_07       (0x80000080)  // reserved
//
...
#define DT2_TGT_PWM_6       (0x00100040)
#define DT2_TGT_PWM_7       (0x00100080)
//
#define DT2_TGT_LED_0       (0x00200001)
#define DT2_TGT_LED_1       (0x00200002)
#define DT2_TGT_LED_2       (0x00200004)
#define DT2_TGT_LED_3       (0x00200008)
...
// Power over Ethernet (PoE) ports enable/disable
//
...
// Power over Ethernet (PoE) ports on the PCI card (PCI)
//
...
BOOL __cdecl DT2_SetUnit(DWORD unit, int delta);  // unit: micro-second(25~2500us), delta: fine-tuning(+/- 0.0125us)
WORD __cdecl DT2_GetUnit(void);  // unit in micro-second
BOOL __cdecl DT2_StPush(DWORD mask, DWORD value);  // software trigger, write data to controller (trigSrc, SI)
BOOL __cdecl DT2_StPull(DWORD *lpValue);  // software trigger, read data from controller (trigTgt, SO)
BOOL __cdecl DT2_EiRegisterIndexed(void (__stdcall *pfnHandler)(DWORD data));  // external input, indexed (0~31) callback
BOOL __cdecl DT2_EiSendResult(DWORD idx, DWORD value);  // external input, send indexed result
